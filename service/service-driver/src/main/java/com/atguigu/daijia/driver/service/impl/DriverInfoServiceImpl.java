...
public class DriverInfoServiceImpl extends ServiceImpl<DriverInfoMapper, DriverInfo> implements DriverInfoService {
    ...
    public Boolean verifyDriverFace(DriverFaceModelForm driverFaceModelForm) {
        ...
        try{
            ...
            if(resp.getIsMatch()) { //照片比对成功
                //2 如果照片比对成功，静态活体检测
                Boolean isSuccess = detectLiveFace(driverFaceModelForm.getImageBase64());
    ...
    public DriverInfoVo getDriverInfoOrder(Long driverId) {
        ...
        int startYear = new DateTime(driverInfo.getDriverLicenseIssueDate()).getYear();
        int driverLicenseAge = currentYear - startYear;
